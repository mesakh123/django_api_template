...
from websystem.settings.dev import DEFAULT_FROM_EMAIL

from .models import Enquiry
from .serializers import EnquirySerializer


@extend_schema(request=EnquirySerializer)
@api_view(["POST"])
...
def send_enquiry_email(request):
    ...
    try:
        ...
        return Response({"fail": "Enquiry was not sent. Please try again. " + str(e)})
